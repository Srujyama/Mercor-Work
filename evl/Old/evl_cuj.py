...
# Output field (single view target)
...
def main():
    parser = argparse.ArgumentParser(
        description="Parallel Gemini 3.0 Airtable generator (CUJ single-view)."
    )
    parser.add_argument(
